...
<p class="caption">Structure of the LCZ sample dataset showing date, station, temperature, and coordinates columns</p>
</div>
...
<p class="caption">LCZ time series analysis showing temperature variations across different LCZ classes</p>
</div>
...
<p class="caption">Thermal anomaly map showing temperature differences across urban zones</p>
</div>
...
<p class="caption">Spatial interpolation of air temperature across the study area</p>
</div>
