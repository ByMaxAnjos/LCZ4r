...
You can watch a detailed tutorial on installing LCZ4r in QGIS below: <!-- Embedded Video --> <iframe width="560" height="315" 
        src="https://www.youtube.com/embed/fM2Mf94eA7w" 
        title="Installing LCZ4r in QGIS" 
...
-   Download and install R (version <= 4.3) from CRAN for your operating system: [Windows](https://cran.r-project.org/bin/windows/base/old/4.3.3/), [macOS](https://cran.r-project.org/bin/macosx/big-sur-arm64/base/), or [Linux](https://www.r-project.org/).
-   If using Windows, also install the corresponding version of [Rtools](https://cran.r-project.org/bin/windows/Rtools/). 
-   **Tip**: Ensure R is added to your system’s PATH so QGIS can interact with it.
