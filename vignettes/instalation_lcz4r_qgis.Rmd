...
<div style="text-align: center;">
  <!-- Image Thumbnail with Link to Video -->
  <a href="https://www.youtube.com/watch?v=RalGSgx8v2Q" target="_blank">
    <img src="https://img.youtube.com/vi/RalGSgx8v2Q/hqdefault.jpg" 
         alt="LCZ4r Installation Tutorial" 
         width="560" height="315" style="border: 2px solid #ddd; border-radius: 8px; margin-bottom: 10px;">
  </a>
</div>
