...
#Calculate the hourly UHI intensity for 2019 using the LCZ method
...
#Calculate the hourly UHI intensity for 13-15 Feb 2019 using the LCZ method grouping Urban and Rural temperatures 
lcz_uhi_intensity(lcz_map,
                  data_frame = lcz_data,
                  var = "airT",
                  station_id = "station",
