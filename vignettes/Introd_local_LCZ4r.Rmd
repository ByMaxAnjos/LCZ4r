...
The `lcz_uhi_intensity()` function is designed to calculate the Urban Heat Island (UHI) intensity based on air temperature measurements and Local Climate Zones (LCZ). Here's a detailed description of the function call provided:

```{r, eval=TRUE, fig.height=7, fig.width=11, message=FALSE, warning=FALSE}

#Calculate the hourly UHI intensity for 2019-2020 using the LCZ method
...
#Calculate the hourly UHI intensity for 2020 using the manual method
lcz_uhi_intensity(lcz_map,
                  data_frame = lcz_data,
                  var = "airT",
                  station_id = "station",
...
#Calculate the hourly UHI intensity by months of 2019 using the LCZ method grouping Urban and Rural temperatures 
lcz_uhi_intensity(lcz_map,
                  data_frame = lcz_data,
                  var = "airT",
                  station_id = "station",
...
#Calculate the UHI intensity during daytime and nighttime in April 2019
lcz_uhi_intensity(lcz_map,
                  data_frame = lcz_data,
                  var = "airT",
                  station_id = "station",
